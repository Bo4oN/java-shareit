...
public interface BookingService {
    ...
    List<BookingResult> getAllUserBooking(State status, int userId, int from, int size);

    List<BookingResult> getAllBookingsForAllUserItems(State status, int userId, int from, int size);
}
